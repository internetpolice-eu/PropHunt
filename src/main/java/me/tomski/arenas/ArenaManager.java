...
public class ArenaManager
{
    ...
    public void giveSetupTools(final Player p) {
        ...
        t1meta.setLore((List)Arrays.asList(ChatColor.RED + "Place this to set Hider Spawn!"));
        ...
        t2meta.setLore((List)Arrays.asList(ChatColor.BLUE + "Place this to set the Seeker Spawn!"));
        ...
        t3meta.setLore((List)Arrays.asList(ChatColor.GREEN + "Click this at the Lobby spawn location", ChatColor.GREEN + "corner of your arena!"));
        ...
        t4meta.setLore((List)Arrays.asList(ChatColor.GREEN + "Click this at the Spectator spawn location", ChatColor.GREEN + "corner of your arena!"));
        ...
        t4meta2.setLore((List)Arrays.asList(ChatColor.GREEN + "Click this at the Exit spawn location", ChatColor.GREEN + "corner of your arena!"));
    ...
    public boolean deleteArena(final String string) {
        ...
        for (final String a : ArenaManager.playableArenas.keySet()) {
            if (a.equalsIgnoreCase(string)) {
                ...
                this.plugin.AS.getStorageFile().set("Arenas." + a, (Object)null);
                this.plugin.AS.saveStorageFile();
                this.plugin.getConfig().set("CustomArenaConfigs." + a, (Object)null);
